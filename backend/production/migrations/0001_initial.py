    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.CharField(
                        editable=False, max_length=20, unique=True, verbose_name="Número OT"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("OUTSOURCING_ASSIGNMENT", "Asignación de Tercerizados"),
                            ("PREPRESS", "Pre-Impresión"),
                            ("PRESS", "Impresión"),
                            ("POSTPRESS", "Post-Impresión"),
                            ("OUTSOURCING_VERIFICATION", "Verificación de Tercerizados"),
                            ("RECTIFICATION", "Rectificación"),
                            ("FINISHED", "Finalizada"),
                            ("CANCELLED", "Cancelada"),
                        ],
                        default="MATERIAL_ASSIGNMENT",
                        max_length=30,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Papel, Tintas, Terminaciones, etc.",
                ...
                (
                    ...
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha Estimada de Finalización"
                    ),
                ),
                (
                    "start_date",
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=12,
                        null=True,
                        verbose_name="Cantidad Real Producida",
                    ),
                ),
                (
                    "is_rectified",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Sin materiales de stock",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_outsourced",
                    models.BooleanField(default=False, verbose_name="Es Tercerizado"),
                ),
                (
                    "unit_price",
                    models.DecimalField(
                        ...
                        max_digits=12,
                        validators=[django.core.validators.MinValueValidator(0)],
                        verbose_name="Precio Unitario OC",
                    ),
                ),
                (
                    "document_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Ej: BOM Camiseta Roja v1", max_length=255, verbose_name="Nombre"
                    ),
                ),
                (
                    "active",
                    models.BooleanField(
                        default=True,
                        help_text="Solo puede haber un BOM activo por producto",
                        verbose_name="Activo",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sequence",
                    models.IntegerField(
                        default=10, help_text="Orden de visualización", verbose_name="Secuencia"
                    ),
                ),
                (
                    "bom",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.CharField(
                        db_index=True, editable=False, max_length=20, verbose_name="Número OT"
                    ),
                ),
                ("description", models.CharField(max_length=255, verbose_name="Descripción")),
                ("is_manual", models.BooleanField(default=False, verbose_name="Es Manual")),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="+",
                        to="contacts.contact",
                        verbose_name="Contacto Relacionado",
                    ),
                ),
                (
                    "related_note",
