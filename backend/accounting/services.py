...
class AccountingService:
    ...
    def populate_ifrs_coa():
        ...
        """
        from .models import BSCategory, CFCategory, ISCategory
        ...
        coa_data = [
            ...
            (
                "1.1.03.03",
                "Inventario de Productos Fabricables",
                AccountType.ASSET,
                "1.1.03",
                None,
                None,
            ...
            (
                "1.1.04.03",
                "Retenciones de Impuestos (Activo)",
                AccountType.ASSET,
                "1.1.04",
                None,
                None,
            ...
            (
                "1.1.06.03",
                "IVA Comisiones Terminal (Puente)",
                AccountType.ASSET,
                "1.1.06",
                None,
                None,
            ...
            (
                "2.1.02.03",
                "Retenciones Honorarios por Pagar",
                AccountType.LIABILITY,
                "2.1.02",
                None,
                None,
            ...
            (
                "2.1.02.06",
                "Impuesto Adicional (ILA) por Pagar",
                AccountType.LIABILITY,
                "2.1.02",
                None,
                None,
            ...
            (
                "2.1.02.08",
                "Ajuste Conciliación - Retenciones",
                AccountType.LIABILITY,
                "2.1.02",
                None,
                None,
            ...
            (
                "2.1.04.01",
                "Intereses por Pagar (Devengados)",
                AccountType.LIABILITY,
                "2.1.04",
                None,
                None,
            ...
            (
                "2.1.04.02",
                "Tarjetas de Crédito por Pagar (Pasivo)",
                AccountType.LIABILITY,
                "2.1.04",
                None,
                None,
            ...
            (
                "3.1.06",
                "Utilidades del Ejercicio (Distribuciones)",
                AccountType.EQUITY,
                "3.1",
                None,
                None,
            ...
            (
                "3.2.01",
                "Utilidades Retenidas (Consolidada)",
                AccountType.EQUITY,
                "3.2",
                None,
                None,
            ...
            (
                "4.2.01",
                "Ajuste de Precios / Otros Ingresos",
                AccountType.INCOME,
                "4.2",
                None,
                None,
            ...
            (
                "4.2.02",
                "Ganancia por Ajuste de Inventario",
                AccountType.INCOME,
                "4.2",
                None,
                None,
            ...
            (
                "4.2.07",
                "Ingreso por Corrección Monetaria",
                AccountType.INCOME,
                "4.2",
                None,
                None,
            ...
            (
                "5.2.01.02",
                "Cotizaciones Previsionales Patronales",
                AccountType.EXPENSE,
                "5.2.01",
                None,
                None,
            ...
            (
                "5.2.03",
                "Servicios Básicos (Agua, Luz, Tel)",
                AccountType.EXPENSE,
                "5.2",
                None,
                None,
            ...
            (
                "5.2.07",
                "Pérdida por Ajuste de Inventario",
                AccountType.EXPENSE,
                "5.2",
                None,
                None,
            ...
            (
                "5.2.17",
                "Errores de Conteo y Sistema POS",
                AccountType.EXPENSE,
                "5.2",
                None,
                None,
            ...
            (
                "5.2.18",
                "Asignaciones y Bonos No Imponibles",
                AccountType.EXPENSE,
                "5.2",
                None,
                None,
            ...
            (
                "5.2.21",
                "Gasto por Comisión de Apertura",
                AccountType.EXPENSE,
                "5.2",
                None,
                None,
            ...
            (
                "5.2.22",
                "Gasto por Impuesto de Timbres (ITE)",
                AccountType.EXPENSE,
                "5.2",
                None,
                None,
            ...
            (
                ...
                AccountType.EXPENSE,
                None,
                ISCategory.TAX_EXPENSE,
                None,
                None,
            ),
            (
                "5.4.01",
                "Gasto Impuesto a la Renta (Provisionado)",
                AccountType.EXPENSE,
                "5.4",
                None,
                None,
        ...
        for code, name, type_code, parent_code, is_cat, cf_cat, bs_cat in coa_data:
            ...
            if parent:
                if is_cat is None:
                    is_cat = parent.is_category
                if cf_cat is None:
                    cf_cat = parent.cf_category
                if bs_cat is None:
                    bs_cat = parent.bs_category
        ...
        for line in delivery.lines.all():
            ...
            if not product.track_inventory and product.strategy.requires_manufacturing_profile:
                ...
                if line.sale_line.work_orders.exists():
                    ...
                    print(
                        f"DEBUG: Skipping COGS entry for {product.internal_code} - already expensed in OT"
                    )
                    continue
            ...
            if not cogs_account:
                raise ValidationError(
                    f"Falta configuración de cuenta de costo/gasto para el producto {product.internal_code}."
                )
                ...
                if active_bom:
                    ...
                    if not bom_lines:
                        ...
                        if not inventory_account:
                            raise ValidationError(
                                f"Falta configuración de cuenta de inventario para el producto {product.internal_code}."
                            )
                        credits[inventory_account] = (
                    ...
                    for bom_line in bom_lines:
                        ...
                        try:
                            base_comp_qty = UoMService.convert_quantity(
                                comp_qty, from_uom=bom_line.uom, to_uom=component.uom
                            )
                        ...
                        if not comp_inventory_account:
                            raise ValidationError(
                                f"Falta configuración de cuenta de inventario para el componente {component.internal_code}."
                            )

                        credits[comp_inventory_account] = (
                            credits.get(comp_inventory_account, Decimal("0.00")) + comp_cost
                        )
...
class BudgetService:
    ...
    def get_variance_report(budget: Budget, year: int, month: int):
        ...
        # Monthly Budget
        m_budget_qs = (
            budget.items.filter(year=year, month=month)
            .values("account_id")
        ...
        # YTD Budget
        y_budget_qs = (
            budget.items.filter(Q(year__lt=year) | Q(year=year, month__lte=month))
            .values("account_id")
            .annotate(total=Sum("amount"))
        )
    ...
    def get_previous_year_actuals(budget: Budget):
        ...
        from django.db.models import ExtractMonth, Sum
        ...
        grouped = items_qs.values("account", "month").annotate(
            debit_sub=Sum("debit"), credit_sub=Sum("credit")
        )

        results = []
        # We need account types to calculate balance correctly
        accounts_map = {
            a.id: a for a in Account.objects.filter(id__in=[g["account"] for g in grouped])
        }
