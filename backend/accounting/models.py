...
class JournalItem(models.Model):
    ...
    debit = models.DecimalField(_("Debe"), max_digits=20, decimal_places=2, default=Decimal('0'), validators=[MinValueValidator(0)])
    credit = models.DecimalField(_("Haber"), max_digits=20, decimal_places=2, default=Decimal('0'), validators=[MinValueValidator(0)])
...
class BudgetItem(models.Model):
    ...
    amount = models.DecimalField(_("Monto Presupuestado"), max_digits=20, decimal_places=2, validators=[MinValueValidator(0)])
