    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Cuenta de activo para registrar adelantos a trabajadores.",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="settings_hr_anticipos",
                to="accounting.account",
                verbose_name="Cuenta Anticipos de Remuneraciones",
            ),
        ),
        migrations.AddField(
            model_name="accountingsettings",
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Pasivo consolidado para pagos a instituciones previsionales.",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="settings_hr_previred_por_pagar",
                to="accounting.account",
                verbose_name="Cuenta Obligaciones Previred por Pagar",
            ),
        ),
        migrations.AddField(
            model_name="accountingsettings",
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Pasivo con el trabajador por su sueldo líquido.",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="settings_hr_rem_por_pagar",
                to="accounting.account",
                verbose_name="Cuenta Remuneraciones por Pagar",
            ),
        ),
