...
from .views import ProductViewSet, CategoryViewSet, WarehouseViewSet, StockMoveViewSet, ProductAttributeViewSet, ProductAttributeValueViewSet, UoMViewSet, UoMCategoryViewSet
