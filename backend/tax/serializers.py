...
class AccountingPeriodSerializer(serializers.ModelSerializer):
    ...
    tax_period_id = serializers.IntegerField(
        source="tax_period.id", read_only=True, allow_null=True
    )
    tax_period_status = serializers.CharField(
        source="tax_period.status", read_only=True, allow_null=True
    )
...
class F29DeclarationSerializer(serializers.ModelSerializer):
    ...
    total_credits_available = serializers.DecimalField(
