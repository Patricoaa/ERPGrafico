...
def generate_report_task(self, report_type, **kwargs):
    ...
    """
    try:
        fy_id = kwargs.get("fiscal_year_id")
        if report_type == "trial_balance":
            ...
            return FinanceService.get_balance_sheet(end_date, start_date, comp_end, comp_start, fiscal_year_id=fy_id)
            ...
            comp_end = _to_date(kwargs.get("comp_end_date"))
            comp_start = _to_date(kwargs.get("comp_start_date"))
            return FinanceService.get_income_statement(start_date, end_date, comp_start, comp_end, fiscal_year_id=fy_id)
            ...
            comp_end = _to_date(kwargs.get("comp_end_date"))
            comp_start = _to_date(kwargs.get("comp_start_date"))
            return FinanceService.get_cash_flow(start_date, end_date, comp_start, comp_end, fiscal_year_id=fy_id)
