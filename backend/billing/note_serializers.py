...
class NoteWorkflowSerializer(serializers.ModelSerializer):
    ...
    corrected_invoice_display = serializers.CharField(
        source="corrected_invoice.display_id", read_only=True
    )
    corrected_invoice_number = serializers.CharField(
        source="corrected_invoice.number", read_only=True
    )
    corrected_invoice_total = serializers.DecimalField(
        source="corrected_invoice.total", max_digits=12, decimal_places=0, read_only=True
    )
    ...
    total_net = serializers.DecimalField(
        source="invoice.total_net", max_digits=12, decimal_places=0, read_only=True
    )
    total_tax = serializers.DecimalField(
        source="invoice.total_tax", max_digits=12, decimal_places=0, read_only=True
    )
    total = serializers.DecimalField(
        source="invoice.total", max_digits=12, decimal_places=0, read_only=True
    )
