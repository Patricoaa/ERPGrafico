    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="PIN para Punto de Venta (hasheado)",
                        max_length=128,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.OneToOneField(
                        blank=True,
                        help_text="Vínculo con la entidad física de Contacto",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "trade_name",
                    models.CharField(blank=True, max_length=255, verbose_name="Nombre de Fantasía"),
                ),
                ...
                (
                    "primary_color",
                    models.CharField(
                        blank=True, default="#000000", max_length=7, verbose_name="Color Primario"
                    ),
                ),
                (
                    "secondary_color",
                    models.CharField(
                        blank=True, default="#ffffff", max_length=7, verbose_name="Color Secundario"
                    ),
                ),
                (
                    "business_activity",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Giro / Actividad Económica"
                    ),
                ),
                (
                    "contact",
                    models.ForeignKey(
                        blank=True,
                        help_text="Vínculo con el contacto que representa a esta empresa",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
