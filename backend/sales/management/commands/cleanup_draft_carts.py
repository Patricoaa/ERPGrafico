...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.WARNING(f"Eliminando borradores de más de {days} día(s)..."))
        ...
        if deleted_count > 0:
            ...
            self.stdout.write(self.style.SUCCESS("✓ No hay borradores antiguos para eliminar"))
