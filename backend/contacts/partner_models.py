...
class PartnerTransaction(models.Model):
    ...
    transaction_type = models.CharField(
        _("Tipo de Transacción"), max_length=20, choices=Type.choices
    )
...
class PartnerEquityStake(models.Model):
    ...
    effective_from = models.DateField(
        _("Vigente Desde"), help_text=_("Fecha desde la que rige este porcentaje de participación.")
    )
...
class ProfitDistributionResolution(models.Model):
    ...
    resolution_date = models.DateField(
        _("Fecha de Resolución"), help_text=_("Fecha del acta o resolución de distribución.")
    )
...
class ProfitDistributionLineDestination(models.Model):
    ...
    destination = models.CharField(_("Destino"), max_length=20, choices=Destination.choices)
    amount = models.DecimalField(_("Monto"), max_digits=16, decimal_places=0)
...
class ProfitDistributionPayment(models.Model):
    ...
    amount = models.DecimalField(_("Monto Pagado"), max_digits=16, decimal_places=0)
