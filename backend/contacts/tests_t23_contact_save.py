...
class ContactSaveT23Tests(TestCase):
    def setUp(self):
        ...
        Account.objects.create(
            name="Assets", account_type=AccountType.ASSET, code="1"
        )
        equity_parent = Account.objects.create(
            name="Equity", account_type=AccountType.EQUITY, code="3"
        )
        liability_parent = Account.objects.create(
            name="Liability", account_type=AccountType.LIABILITY, code="2"
        )
    ...
    def test_contact_save_does_not_create_partner_accounts(self):
        ...
        """
        contact = Contact.objects.create(name="Test Partner", tax_id="12345678-9", is_partner=True)
    ...
    def test_promote_to_partner_succeeds(self):
        ...
        contact = Contact.objects.create(
            name="Test Partner Service", tax_id="98765432-1", is_partner=False
        )
