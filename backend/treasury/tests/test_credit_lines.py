...
class TestCreditLineModel:
    ...
    def test_auto_renewal_with_term_valid(self, base):
        cl = _make_credit_line(
            treasury_account=base["bank_ta"], auto_renewal=True, renewal_term_months=12
        )
        cl.full_clean()
    ...
    def test_utilization_rate_none_when_no_credit_limit(self, base):
        cl = _make_credit_line(treasury_account=base["bank_ta"], credit_limit=Decimal("0"))
