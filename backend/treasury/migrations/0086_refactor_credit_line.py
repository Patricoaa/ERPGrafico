    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DecimalField(
                blank=True,
                decimal_places=2,
                help_text="Monto máximo autorizado por el banco para esta línea de crédito.",
                max_digits=18,
                null=True,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ("INBOUND", "Entrante (Cobro/Venta)"),
                    ("OUTBOUND", "Saliente (Pago/Gasto)"),
                    ("TRANSFER", "Traspaso Interno"),
                    ("ADJUSTMENT", "Ajuste"),
                    ("CREDIT_LINE_DRAW", "Disposición Línea de Crédito"),
                    ("CREDIT_LINE_REPAY", "Abono Línea de Crédito"),
                ],
                max_length=20,
                verbose_name="Tipo",
            ),
        ...
        migrations.AddIndex(
            model_name="creditline",
            index=models.Index(
                fields=["treasury_account", "status"], name="treasury_cr_treasur_5902af_idx"
            ),
        ),
        # Remove old fields
        migrations.RemoveField(
