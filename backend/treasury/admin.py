...
class TreasuryMovementAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Asignación", {"fields": ("contact", "invoice", "sale_order", "purchase_order")}),
        (
...
class BankStatementAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Balances", {"fields": ("opening_balance", "closing_balance")}),
        ("Archivo", {"fields": ("file",)}),
        (
            "Estadísticas",
            {
        ...
        (
            "Metadatos",
            {"fields": ("display_id", "imported_at", "imported_by"), "classes": ("collapse",)},
        ),
    )
...
class BankStatementLineAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Cartola", {"fields": ("statement", "line_number")}),
        (
            "Datos Bancarios",
            {
                "fields": (
        ...
        ("Montos", {"fields": ("debit", "credit", "balance", "amount")}),
        ("Reconciliación", {"fields": ("reconciliation_status", "reconciled_at", "reconciled_by")}),
        (
            "Diferencias",
            {
...
class ReconciliationSettingsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información Básica", {"fields": ("treasury_account", "auto_confirm")}),
        (
            "Pesos de Scoring",
            {"fields": ("amount_weight", "date_weight", "reference_weight", "contact_weight")},
        ),
        ("Lógica del Motor", {"fields": ("confidence_threshold", "date_range_days")}),
    )
...
class TerminalBatchAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información Básica", {"fields": ("provider", "terminal_reference", "status")}),
        ("Fechas", {"fields": ("sales_date", "settlement_date", "deposit_date")}),
        (
            "Montos",
            {
                "fields": (
        ...
        ("Estadísticas", {"fields": ("payment_count",), "classes": ("collapse",)}),
        ("Notas", {"fields": ("notes",), "classes": ("collapse",)}),
        (
            "Metadatos",
            {"fields": ("display_id", "created_at", "created_by"), "classes": ("collapse",)},
        ),
    )
