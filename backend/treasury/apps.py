        ...
        try:
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    short_display_template=f"{EntityPrefix.TREASURY_MOVEMENT}-{{id}}",
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    short_display_template=f"{EntityPrefix.BANK_STATEMENT}-{{id}}",
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    short_display_template=f"{EntityPrefix.CHECK}-{{check_number}}",
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    short_display_template=f"{EntityPrefix.BANK_LOAN}-{{loan_number}}",
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    short_display_template=f"{EntityPrefix.CREDIT_CARD_STMT}-{{id}}",
                    display_template=f"{EntityPrefix.CREDIT_CARD_STMT}-{{id}}",
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    short_display_template=f"{EntityPrefix.LOAN_INSTALLMENT}-{{id}}",
            ...
            UniversalRegistry.register(
                SearchableEntity(
                    ...
                    search_fields=(
                        ...
                        "treasury_account__bank__name",
                    ),
                    short_display_template=f"{EntityPrefix.CREDIT_LINE}-{{code}}",
                    display_template=f"{EntityPrefix.CREDIT_LINE}-{{code}}",
                    subtitle_template="{treasury_account.name} · {credit_limit}",
                    extra_info_template="{status}",
                    list_url="/treasury/bank-center",
                    detail_url_pattern="/treasury/bank-center",
