...
class BankStatementLineViewSet(viewsets.ModelViewSet):
    ...
    queryset = BankStatementLine.objects.all().select_related(
        ...
        "reconciliation_match__movements__invoice__contact",
        "reconciliation_match__movements__invoice__sale_order__customer",
        "reconciliation_match__movements__invoice__purchase_order__supplier",
        "reconciliation_match__movements__sale_order__customer",
        "reconciliation_match__movements__purchase_order__supplier",
        "reconciliation_match__movements__journal_entry",
        "reconciliation_match__movements__account",
        "reconciliation_match__movements__from_account__account",
        "reconciliation_match__movements__to_account__account",
        "reconciliation_match__movements__payment_method_new",
        "reconciliation_match__movements__reconciled_by",
        "reconciliation_match__movements__created_by",
        "reconciliation_match__movements__bank_statement_line__statement",
        "reconciliation_match__movements__card_purchase_group__partner",
        "matched_movements__terminal_batch",
        "matched_movements__contact",
        "matched_movements__invoice__contact",
        "matched_movements__invoice__sale_order__customer",
        "matched_movements__invoice__purchase_order__supplier",
        "matched_movements__sale_order__customer",
        "matched_movements__purchase_order__supplier",
        "matched_movements__journal_entry",
        "matched_movements__account",
        "matched_movements__from_account__account",
        "matched_movements__to_account__account",
        "matched_movements__payment_method_new",
        "matched_movements__reconciled_by",
        "matched_movements__created_by",
        "matched_movements__bank_statement_line__statement",
        "matched_movements__card_purchase_group__partner",
    )
