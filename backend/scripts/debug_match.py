...
from treasury.models import BankStatementLine, ReconciliationSettings, TreasuryMovement
...
if line and movement:
    print(
        f"Line: {line.description}, Date: {line.transaction_date}, Amount: {line.credit - line.debit}"
    )
