    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h3 className="text-lg font-semibold">Categorías de Servicio</h3>
                            ...
                            <TableRow key={cat.id} className="group hover:bg-muted/20 transition-colors">
                                ...
                                <TableCell className="text-sm">
                                    <div className="flex flex-col">
                                        <span className="font-mono text-[10px] text-muted-foreground">{cat.expense_account_data?.code}</span>
                                        <span>{cat.expense_account_data?.name}</span>
                                    </div>
                                </TableCell>
                                <TableCell className="text-sm">
                                    <div className="flex flex-col">
                                        <span className="font-mono text-[10px] text-muted-foreground">{cat.payable_account_data?.code}</span>
                                        <span>{cat.payable_account_data?.name}</span>
                                    </div>
                                </TableCell>
                                <TableCell className="text-sm">{cat.requires_provision ? 'Sí' : 'No'}</TableCell>
                                <TableCell>
