                        ...
                        <TooltipTrigger asChild>
                            ...
                            >
                                ...
                                {pendingCount > 0 && !isInboxOpen && (
                                    <span className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] flex items-center justify-center bg-destructive text-destructive-foreground text-3xs font-medium rounded-full px-1 shadow-card border border-background">
