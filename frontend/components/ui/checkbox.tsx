...
const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
    ({ className, checked, onCheckedChange, variant = "default", ...props }, ref) => {
        ...
        return (
            <div className={cn(isCircle ? "grid place-items-center h-4 w-4" : "relative flex items-center")}>
                <input
                    type="checkbox"
                    ref={inputRef}
                    ...
                    className={cn(
                        ...
                        isCircle
                            ? "col-start-1 row-start-1 rounded-full border-muted-foreground/30 checked:bg-transparent"
                ...
                {isCircle ? (
                    checked === true ? (
                        <CmykRing size="sm" className="col-start-1 row-start-1 pointer-events-none" />
                    ) : isIndeterminate ? (
