...
export function ReplenishmentRuleList() {
    ...
    const columns: ColumnDef<ReorderingRule>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => <div>{row.getValue("warehouse_name")}</div>,
        },
        {
            accessorKey: "min_quantity",
            header: ({ column }) => <DataTableColumnHeader column={column} title="Mínimo" className="justify-end" />,
        ...
        },
        {
            ...
            header: ({ column }) => <DataTableColumnHeader column={column} title="Máximo" className="justify-end" />,
        ...
        {
            id: "actions",
            header: ({ column }) => <DataTableColumnHeader column={column} title="Acciones" className="text-right" />,
            cell: ({ row }) => (
                <div className="flex justify-end gap-2">
                    <Button variant="ghost" size="icon" onClick={() => { setEditingRule(row.original); setIsDialogOpen(true); }}>
