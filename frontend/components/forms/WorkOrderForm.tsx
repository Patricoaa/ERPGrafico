        ...
        if (open) {
            ...
            if (initialData) {
                form.reset({
                    ...
                    sale_line: initialData.sale_line?.id?.toString() || (typeof initialData.sale_line === 'string' ? initialData.sale_line : "") || "",
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 py-8 max-w-md mx-auto">
                                ...
                                <div className="grid grid-cols-1 w-full gap-3">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        className="h-16 justify-start px-4 gap-4 hover:border-primary hover:bg-primary/5 group"
                                    ...
                                    <Button
                                        type="button"
                                        variant="outline"
                                        className="h-16 justify-start px-4 gap-4 hover:border-amber-500 hover:bg-amber-50/50 group"
                                        onClick={() => setOtType("NONE")}
                                    >
                                        <div className="h-10 w-10 rounded-full bg-amber-500/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
