                ...
                return (
                    <div
                        ...
                        className={cn(
                            ...
                            isPast && !isActive && "bg-green-50 text-green-700 hover:bg-green-100",
                    ...
                    >
                        <div className="flex items-center space-x-3 p-3">
                            <Icon className={cn("h-5 w-5 shrink-0", isActive ? "text-primary-foreground" : (isPast ? "text-green-600" : "text-muted-foreground"))} />
                            <span className="text-sm font-medium flex-1">{stage.label}</span>
                            {isPast && <CheckCircle2 className={cn("h-4 w-4", isActive ? "text-primary-foreground" : "text-green-600")} />}
