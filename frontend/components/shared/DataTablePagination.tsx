...
export function DataTablePagination<TData>({
    ...
    return (
        <div className="flex items-center justify-between px-1.5">
            <div className="flex-1 text-3xs uppercase tracking-widest text-muted-foreground/60">
            ...
            <div className="flex items-center space-x-6 lg:space-x-8">
                <div className="flex items-center space-x-2">
                    <p className="text-3xs uppercase tracking-widest text-muted-foreground/60 hidden sm:inline">Registros por página</p>
                    <DropdownMenu>
                ...
                <div className="flex w-[100px] items-center justify-center text-3xs uppercase tracking-widest text-muted-foreground/60">
