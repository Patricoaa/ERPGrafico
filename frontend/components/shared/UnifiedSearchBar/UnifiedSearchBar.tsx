              ...
              <div className="flex items-center gap-1 shrink-0">
                {chips.map((chip) => (
                  <span
                    key={chip.id}
                    className={cn(
                      "inline-flex items-center gap-1 h-5 px-1.5 rounded-sm text-[11px] font-medium whitespace-nowrap shrink-0",
                  ...
                  >
                    <span className="max-w-[120px] truncate">{chip.valueLabel}</span>
                    <button
                      type="button"
