...
const CMYK_WHEEL =
  'conic-gradient(from 0deg, var(--color-magenta) 0deg 90deg, var(--color-yellow) 90deg 180deg, var(--color-black) 180deg 270deg, var(--color-cyan) 270deg 360deg)'
 ...
 *
 * Sizes: 2xs (8px), xs (12px), sm (16px), md (24px), lg (32px). Pass className to add rings,
