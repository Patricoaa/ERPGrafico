...
function VentasForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de ventas...">
...
function FacturacionForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de facturación...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function ComprasForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de compras...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function InventarioForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de inventario...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function TesoreriasForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de tesorería...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function RRHHForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de RRHH...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function SociosForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de socios...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function EstructuraForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando estructura contable...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
...
function ImpuestosForm() {
    ...
    return (
        <SkeletonShell isLoading={isLoading && !settings} ariaLabel="Cargando configuración de impuestos...">
            <div className="space-y-6">
                <div className="flex justify-end">
                    <AutoSaveStatusBadge status={status} invalidReason={invalidReason} lastSavedAt={lastSavedAt} onRetry={retry} />
                </div>
