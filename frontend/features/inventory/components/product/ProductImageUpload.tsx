    ...
    return (
        <div className="space-y-2">
            <FormField<ProductFormValues>
                ...
                render={({ field }) => (
                    <FormItem>
                        <div className="relative group w-full h-[143px] rounded-2xl border-2 border-dashed border-muted-foreground/20 overflow-hidden bg-muted/10 flex items-center justify-center transition-all hover:border-primary/50">
                            {imagePreview ? (
                                <>
                                    <Image
                                        src={imagePreview}
