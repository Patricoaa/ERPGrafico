    ...
    return (
        <section className="py-4 space-y-3">
            ...
            <div className="relative group/deuda">
                <div className="flex items-center gap-4 text-sm border-t border-border/40 group-hover/deuda:border-b py-2">
                ...
                <div className="hidden group-hover/deuda:block pt-2">
                    <div className="flex items-center gap-3 text-[11px] text-warning bg-warning/5 border border-warning/20 rounded-md px-3 py-2">
                        <span>
