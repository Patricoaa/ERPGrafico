...
import type {
    ...
    PrepayLoanPayload, RefinanceLoanPayload, LoanInstallment,
} from './types'
...
export const loansApi = {
    ...
    disburse: async (id: number): Promise<BankLoan> => {
        const { data } = await api.post<BankLoan>(`/treasury/loans/${id}/disburse/`, {})
        return data
    },
