...
export const MODULE_REGISTRY: Record<string, ModuleConfig> = {
  ...
  treasury:    { id: "treasury",    label: "Tesorería",     icon: Home,          iconName: "home",           primaryEntityLabel: 'treasury.treasurymovement',            permission: "treasury.view_dashboard_treasury",          defaultUrl: "/treasury/operaciones/movements?view=list" },
