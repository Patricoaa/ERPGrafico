...
export const MODULE_REGISTRY: Record<string, ModuleConfig> = {
  ...
  inventory:   { id: "inventory",   label: "Inventario",    icon: Package,        iconName: "package",        primaryEntityLabel: 'inventory.product',                    permission: "inventory.view_dashboard_inventory",        defaultUrl: "/inventory/products?view=card" },
