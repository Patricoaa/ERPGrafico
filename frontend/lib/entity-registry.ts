...
export const ENTITY_REGISTRY: Record<string, EntityMetadata> = {
  ...
  'inventory.category': {
    ...
    iconName: 'Tag',
    shortTemplate: '{name}',
    listUrl: '/inventory/products/categories',
  ...
  'inventory.uomcategory': {
    ...
    iconName: 'List',
    shortTemplate: '{name}',
    listUrl: '/inventory/uoms/categories',
  ...
  'inventory.pricingrule': {
    ...
    iconName: 'Percent',
    shortTemplate: '{name}',
    listUrl: '/inventory/products/pricing-rules',
  ...
  'treasury.bankstatement': {
    ...
    listUrl: '/treasury/reconciliation/statements',
  ...
  'treasury.terminalbatch': {
    ...
    listUrl: '/treasury/terminal-cobro/batches',
    detailUrlPattern: '/treasury/terminal-cobro/batches?selected={id}',
    viewPolicy: { availableViews: ['list', 'card'], defaultView: 'list', cardComponent: 'entity', gridLayout: 'single-column' },
  },
  'treasury.check': {
