...
import { Plus, FileText, CreditCard, Calendar, ArrowRightLeft, Banknote, List, Filter } from "lucide-react"
        ...
        },
        {
            ...
            cell: ({ row }: any) => {
                ...
                const variants: Record<string, "default" | "secondary" | "outline" | "destructive"> = {
                    'PENDING': 'secondary',
                    'SETTLED': 'default', // Using default (primary color) for settled as it's the main completed state for treasury
                    'RECONCILED': 'outline', // Outline for reconciled
                    'INVOICED': 'outline'
                }
        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Registre liquidaciones y comisiones de terminales de cobro (Transbank, Mercado Pago, etc).</p>
                </div>
